...
//       {/* Combined Certifications Section */}
//       <Section
//         title="Academic & Technical Certifications"
//         items={allCerts}
//         colorClass="edu-certs"
//       />
//     </section>
//   );
// };
    ...
    <div className="edu-container">
      {items.map((item, index) => (
        ...
        >
          <div className="edu-header">
            <span
              className={`edu-type-tag ${
                item.type === "Academic" ? "tag-academic" : "tag-technical"
              }`}
            >
              {item.type}
            </span>
